module IconHelper
  # Weather Icons glyphs are solid 30x30 shapes painted with currentColor,
  ...
  def weather_icon(name, size: 32)
    body = Icons::WEATHER.fetch(name.to_s, Icons::WEATHER["cloudy"])
    ...
    stroke = (Icons::VIEWBOX / 2.0 / size).round(3)
